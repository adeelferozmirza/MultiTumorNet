...
def validation(args):
    ...
    msg =  'Complete Tumor: Acc({da_seg_acc:.3f})    IOU ({da_seg_iou:.3f})    mIOU({da_seg_miou:.3f})\n' \
                      'Core: Acc({ll_seg_acc:.3f})    IOU ({ll_seg_iou:.3f})  mIOU({ll_seg_miou:.3f})'.format(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight', default="pretrained/model_99.pth")
